...
['Vigilante'] = Color3.fromRGB(255, 0, 255), -- Changed color to pink
['Liberator'] = Color3.fromRGB(0, 255, 255), -- Changed color to cyan
['Veteran'] = Color3.fromRGB(0, 0, 255),
['Bounty Hunter'] = Color3.fromRGB(255, 165, 0), -- Changed color to orange
}
...
-- Print everyone's role
sendmsg("[CLI] Roles:")
for i, plr in ipairs(game.Players:GetPlayers()) do
    local role = plr:GetAttribute("NSXFA")
    if role then
        wait(0.1) -- Delay before printing each player's role
        sendmsg('[' .. role .. '] (' .. plr.Name .. ')[' .. plr.UserId .. ']')
    end
end
